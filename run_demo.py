...
def main():
    parser = argparse.ArgumentParser(description='CS55 Cross-Modal Evidence Chain Demo')
    parser.add_argument('--config', default='config.sample.json', help='Path to dataset config JSON')
    parser.add_argument('--no-cache', action='store_true', help='Recompute CLIP embeddings')
